...
const parashaSlugKeywords: Array<{slug: string; keywords: string[]}> = [
  ...
  {slug: 'achrei-mot-kedoshim', keywords: ['אחרי מות קדושים', 'אחרי-מות-קדושים', 'acharei mot kedoshim', 'acharei-mot-kedoshim', 'achrei mot kedoshim', 'achrei-mot-kedoshim']},
  {slug: 'achrei-mot', keywords: ['אחרי מות', 'אחרי-מות', 'acharei mot', 'achrei mot']},
